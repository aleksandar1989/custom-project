    ...
    <div class="top-menu">
        <ul class="nav navbar-nav pull-right">
                    ...
                    <li>
                        <ul class="dropdown-menu-list scroller" style="height: 275px;"
                            ...
                            <li>
                                <a href="#">
                                                    <span class="photo">
                                                        <img src="{{ asset('admin_tmpl/images/theme_img/avatar2.jpg') }}"
                            ...
                            <li>
                                <a href="#">
                                                    <span class="photo">
                                                        <img src="{{ asset('admin_tmpl/images/theme_img/avatar3.jpg') }}"
                                                             class="img-circle" alt=""> </span>
                                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                                    <span class="photo">
                                                        <img src="{{ asset('admin_tmpl/images/theme_img/avatar1.jpg') }}"
                                                             class="img-circle" alt=""> </span>
                                                    <span class="subject">
            ...
            <li class="dropdown dropdown-user">
                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                   data-close-others="true">
                    <img alt="" class="img-circle" src="{{ asset('admin_tmpl/images/theme_img/avatar3_small.jpg') }}"/>
