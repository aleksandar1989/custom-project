            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    <div id="site_statistics_loading">
                        <img src="{{ asset('admin_tmpl/images/theme_img/loading.gif') }}" alt="loading"/></div>
                        ...
                        <ul class="chats">
                            <li class="out">
                                <img class="avatar" alt=""
                                     src="{{ asset('admin_tmpl/images/theme_img/avatar2.jpg') }}"/>
                                <div class="message">
                            ...
                            <li class="out">
                                <img class="avatar" alt=""
                                     src="{{ asset('admin_tmpl/images/theme_img/avatar1.jpg') }}"/>
                                <div class="message">
                                    <span class="arrow"> </span>
                                    <a href="javascript:;" class="name"> Lisa Wong </a>
                                    <span class="datetime"> at 20:11 </span>
                            ...
                            <li class="out">
                                <img class="avatar" alt=""
                                     src="{{ asset('admin_tmpl/images/theme_img/avatar3.jpg') }}"/>
                                <div class="message">
                                    <span class="arrow"> </span>
                    ...
                    <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd"
                        ...
                        <ul class="media-list list-items">
                            <li class="media">
                                ...
                                <img class="media-object" src="{{ asset('admin_tmpl/images/theme_img/avatar3.jpg') }}"
                                     alt="...">
                            ...
                            <li class="media">
                                <img class="media-object" src="{{ asset('admin_tmpl/images/theme_img/avatar1.jpg') }}"
                                     alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="{{ asset('admin_tmpl/images/theme_img/avatar4.jpg') }}"
                                     alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="media-object" src="{{ asset('admin_tmpl/images/theme_img/avatar2.jpg') }}"
                                     alt="...">
                                <div class="media-body">
                        ...
                        <ul class="media-list list-items">
                            <li class="media">
                                ...
                                <img class="media-object" src="{{ asset('admin_tmpl/images/theme_img/avatar6.jpg') }}"
                                     alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="{{ asset('admin_tmpl/images/theme_img/avatar7.jpg') }}"
                                     alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="media-object" src="{{ asset('admin_tmpl/images/theme_img/avatar8.jpg') }}"
                                     alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="{{ asset('admin_tmpl/images/theme_img/avatar9.jpg') }}"
                                     alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="media-object" src="{{ asset('admin_tmpl/images/theme_img/avatar10.jpg') }}"
                                     alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="{{ asset('admin_tmpl/images/theme_img/avatar11.jpg') }}"
                                     alt="...">
                                <div class="media-body">
